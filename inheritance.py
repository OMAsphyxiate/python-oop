...
class Boxer(Fighter): #Inherits from the Fighter class, gets the attributes from Fighter class
	def heal(self): #Adds another function for the Boxer class that Fighter doesn't have
		self.health += 10 #adds 10 health
