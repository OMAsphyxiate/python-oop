...
def calculate_age(): #Creates class for what happens when the button is clicked
	EntryDate = Person('UserEntry', datetime.date(int(year_entry.get()), int(month_entry.get()), int(day_entry.get())))
	print("Button was clicked")
	print(EntryDate.age())

#Add button
calculate_button = tk.Button(master=window, text="Calculate Now", command=calculate_age) #Links the command to the created class to execute what is in the class when the button is clicked
